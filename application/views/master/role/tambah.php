			...
			<div class="card shadow mb-4 border-bottom-primary">
				<div class="card-header py-3">
					<div class="row">
						...
						<div class="col-lg">
							<h6 class="m-0 font-weight-bold"><a href="<?= base_url('master/role') ?>" class="btn btn-sm btn-secondary float-right"><i class="fas fa-arrow-left"></i> Kembali</a></h6>
						</div>
					</div>
				</div>
				<div class="card-body">
					<form method="POST" action="<?= base_url('master/role/tambah') ?>">
						<div class="form-group form-row">
							<div class="col-lg">
								<label for="nama_role">Role <span class="text-danger">*</span></label>
								<input type="text" name="nama_role" class="form-control" id="nama_role" autofocus>
