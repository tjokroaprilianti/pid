			...
			<div class="card shadow mb-4 border-bottom-primary">
				<div class="card-header py-3">
					<div class="row">
						...
						<div class="col-lg">
							<h6 class="m-0 font-weight-bold"><a href="<?= base_url('master/cost/unit') ?>" class="btn btn-sm btn-secondary float-right"><i class="fas fa-arrow-left"></i> Kembali</a></h6>
						</div>
					</div>
				</div>
				<div class="card-body">
					<form method="POST" action="<?= base_url('master/cost/unit/tambah') ?>">
						<div class="form-group form-row">
							<div class="col-lg-6">
								<label for="kode_cost_unit">Kode Cost Unit <span class="text-danger">*</span></label>
								<input type="text" name="kode_cost_unit" class="form-control" id="kode_cost_unit" autofocus>
							...
							<div class="col-lg-6">
								...
								<input type="text" name="nama_cost_unit" class="form-control" id="nama_cost_unit">
