		...
		<div class="col-lg">
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="float-right">
									<a href="<?= base_url('admin/profile/hapus_avatar/') . $user->id_user ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i> Hapus</a>
									<a href="<?= base_url('admin/profile/avatar/') . $user->id_user ?>" class="btn btn-sm btn-primary"><i class="fas fa-image"></i> Edit</a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="card shadow mb-4">
				...
				<div class="collapse show" id="collapsePassword">
					<div class="card-body">
						<form action="<?= base_url('admin/profile/reset_password/') . $user->id_user ?>" method="POST">
							<div class="row">
								<div class="col-lg">
									<div class="row justify-content-center">
										<div class="col-lg">
	...
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= base_url('admin/profile/setting/') . $user->id_user; ?>" method="POST">
					<div class="form-group">
