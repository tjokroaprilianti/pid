            ...
            <div class="card shadow mb-4 border-bottom-primary">
                <div class="card-header py-3">
                    <div class="row">
                        ...
                        <div class="col-lg">
                            <h6 class="m-0 font-weight-bold"><a href="<?= base_url('admin/user') ?>" class="btn btn-sm btn-secondary float-right"><i class="fas fa-arrow-left"></i> Kembali</a></h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?= base_url('admin/user/proses_setting/') . $user->id_user ?>">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
