		...
		<div class="card-header py-3">
			<div class="row">
				<div class="col-lg-6 my-auto">
					<h5 class="m-0 font-weight-bold text-gray-600"><i class="fas fa-image"></i> <?=$user->nama_user?></h5>
				</div>
				<div class="col-lg">
					<a href="<?= base_url('user') ?>" class="btn btn-sm btn-danger float-right"><i class="fas fa-undo"></i> Kembali</a>
				</div>
			</div>
			<!-- <h6 class="m-0 font-weight-bold text-primary">DataTables Example</h6> -->
		</div>
		<div class="card-body">
			<form action="<?= base_url('user/ubah_avatar/') . $user->id_user ?>" enctype="multipart/form-data" method="POST">
