							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-4">Lupa Password | PID</h1>
									</div>
									<form class="user" action="<?= base_url('lupa_password') ?>" method="POST">
										<div class="form-group">
											<input type="text" name="email_user" class="form-control form-control-user" id="email" placeholder="email@example.com" value="<?= set_value('email_user'); ?>" autofocus>
											<?= form_error('email_user', '<small class="form-text text-danger">', '</small>'); ?>
										</div>
